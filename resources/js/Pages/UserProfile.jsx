                ...
                <div className="max-w-7xlmy-6 px-4 flex flex-col gap-3">
                    ...
                    <div className="flex flex-col lg:flex-row gap-3">
                        ...
                        <div className="w-full lg:w-[60rem]">
                            <div className="py-4 bg-white border rounded-xl sm:px-6 lg:px-5 flex justify-between">
                        ...
                        <div className="w-full lg:w-1/3 max-w-xs">
                            <div className="py-8 bg-white border rounded-xl sm:px-6 lg:px-8 sticky top-6">
                                {profileUser?.tags?.length > 0 ? (
                                    <div className="flex flex-wrap gap-2">
                                        {profileUser.tags.map((tag) => (
                                            <span
                                                key={tag.id}
                                                className="px-3 py-1 bg-[#7D64DD] text-white text-sm font-medium rounded-full"
                                            >
                                                #{tag.title}
                                            </span>
                                        ))}
