        ...
        <AuthenticatedLayout>
            <Head title={`${tag.title}`} />
                <div className="flex flex-col gap-3">
                    <div className='w-full rounded-md p-[50px] '
                        style={{
                        ...
                        <div>
                            <h2 className="text-[64px] text-white font-bold lowercase">{`${tag.title}`}</h2>
                            <p className='text-[15px] text-white font-medium opacity-70 mt-[-15px]'>Следите за тем, что вам нравится</p>
                        </div>
                    </div>
