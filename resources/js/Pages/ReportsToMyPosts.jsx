                                                ...
                                                <div className="flex flex-col items-start space-x-2">
                                                    ...
                                                    {item.approved === null && (
                                                        <div className="mt-4 flex items-start space-x-3">
                                                            <button onClick={(e) => Accept(e, item.id)} className="px-4 py-2 bg-green-500 text-white text-[14px] rounded-md hover:bg-green-600">
                                                                Принять
                                                            </button>
                                                            <button onClick={(e) => Reject(e, item.id)} className="px-4 py-2 bg-red-500 text-white text-[14px] rounded-md hover:bg-red-600">
                                                                Отклонить
                                                            </button>
                                                        </div>
                                                    )}
