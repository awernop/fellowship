        ...
        <AuthenticatedLayout>
            <Head title="Вызовы" />
                        <div className="flex h-[calc(100vh-100px)] bg-gray-50">
                                        ...
                                        {/* Часть с прокруткой */}
                                        <div className="flex flex-col gap-3 w-full overflow-y-auto pb-10 bg-white rounded-3xl border m-2">
                                            <div className="flex flex-col items-start space-x-2 pt-6 px-9">
