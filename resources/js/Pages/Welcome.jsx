    ...
    return (
        <AuthenticatedLayout>
            ...
            <div className="flex h-screen bg-[#F8F7FB]">
                ...
                {/* Часть с прокруткой */}
                <div className="flex flex-col gap-3 w-full overflow-y-auto pb-10 mx-2 my-6">
                    <div className='w-full rounded-xl p-[80px] '
                        ...
                        <div className='flex items-center gap-2 w-[160px] px-3 py-2 rounded-full border border-[#F0EDFF] border-opacity-20 bg-[#F0EDFF] bg-opacity-20 mb-5'>
                        ...
                        <div className='flex items-center gap-3 mt-9'>
                            <a
                                ...
                                className="`inline-flex items-center rounded-xl bg-night py-[10px] px-10 text-[15px] font-semibold text-white transition duration-300 ease-in-out hover:bg-[#363e4f] shadow-[0_0_30px_rgba(255,255,255,0.3)] focus:bg-[#2A303E] focus:outline-none">
                                К вызовам
                            </a>
                            <a
                                href="#"
