    ...
    return (
        <div className='w-full'>
            <div className='w-full border-b px-3 pb-3'>
                        ...
                        <Dropdown>
                            ...
                            <Dropdown.Content>
                                <div className="flex flex-col items-center justify-center mt-3 pt-4">
                                    {user?.path_img && (
                                        <img
                                            src={`/images/${user.path_img}`}
                                            alt="user pfp"
                                            className="w-[50px] mb-1 rounded-full"
                                        />
                                    )}
                                ...
                                <Dropdown.Link
                                    ...
                                    method="post"
                                    as="button"
                                    className=' hover:bg-gray-100 focus:bg-gray-100 hover:rounded-b-xl'
                                >
                                    Выйти
                                </Dropdown.Link>
                            </Dropdown.Content>
                ...
                <Link href={user ? "/dashboard" : "/"} className={`flex items-center gap-3 w-full px-4 py-2 text-start text-[14px] font-medium rounded-md leading-5 ease-in-out focus:outline-none cursor-pointer
              transition-all duration-200 ${isActive("dashboard") || isActive("posts.welcome") ? "bg-night text-white hover:bg-night focus:bg-night" : "text-[#6F7275] hover:bg-[#F0EDFF] focus:bg-[#F0EDFF]"
                ...
                <Link href="/challenges" className={`flex items-center gap-3 w-full px-4 py-2 text-start text-[14px] font-medium rounded-md leading-5 transition duration-150 ease-in-out focus:outline-none cursor-pointer ${isActive("posts.guest") ? "bg-night text-white hover:bg-[#363e4f] focus:bg-[#363e4f]" : "text-[#6F7275] hover:bg-[#F0EDFF] focus:bg-[#F0EDFF]"
                    }`}>
            ...
            <div className="border-b">
                ...
                <div className='w-full px-3 pb-3'>
                    <Link href={route('tags.show', 'comics')} className={`flex items-center gap-3 w-full px-4 py-2 text-start text-[14px] font-medium rounded-md leading-5  transition duration-150 ease-in-out focus:outline-none cursor-pointer ${isActiveURL("tags/comics") ? "bg-night text-white hover:bg-[#363e4f] focus:bg-[#363e4f]" : "text-[#6F7275] hover:bg-[#F0EDFF] focus:bg-[#F0EDFF]"
                        }`}>
                    ...
                    <Link href={route('tags.show', 'science')} className={`flex items-center gap-3 w-full px-4 py-2 text-start text-[14px] font-medium rounded-md leading-5 transition duration-150 ease-in-out focus:outline-none cursor-pointer ${isActiveURL("tags/science") ? "bg-night text-white hover:bg-[#363e4f] focus:bg-[#363e4f]" : "text-[#6F7275] hover:bg-[#F0EDFF] focus:bg-[#F0EDFF] "}`}>
                    ...
                    <Link href={route('tags.show', 'music')} className={`flex items-center gap-3 w-full px-4 py-2 text-start text-[14px] font-medium rounded-md leading-5 transition duration-150 ease-in-out focus:outline-none cursor-pointer ${isActiveURL("tags/music") ? "bg-night text-white hover:bg-[#363e4f] focus:bg-[#363e4f]" : "text-[#6F7275] hover:bg-[#F0EDFF] focus:bg-[#F0EDFF] "}`}>
                    ...
                    <Link href={route('tags.show', 'activism')} className={`flex items-center gap-3 w-full px-4 py-2 text-start text-[14px] font-medium rounded-md leading-5 transition duration-150 ease-in-out focus:outline-none cursor-pointer ${isActiveURL("tags/activism") ? "bg-night text-white hover:bg-[#363e4f] focus:bg-[#363e4f]" : "text-[#6F7275] hover:bg-[#F0EDFF] focus:bg-[#F0EDFF]"}`}>
                    ...
                    <Link href={route('tags.show', 'videogames')} className={`flex items-center gap-3 w-full px-4 py-2 text-start text-[14px] rounded-md font-medium leading-5 transition duration-150 ease-in-out focus:outline-none cursor-pointer ${isActiveURL("tags/videogames") ? "bg-night text-white hover:bg-[#363e4f] focus:bg-[#363e4f]" : "text-[#6F7275] hover:bg-[#F0EDFF] focus:bg-[#F0EDFF]"}`}>
                    ...
                    <Link href={route('tags.show', 'movie')} className={`flex items-center gap-3 w-full px-4 py-2 text-start text-[14px] font-medium rounded-md leading-5 transition duration-150 ease-in-out focus:outline-none cursor-pointer ${isActiveURL("tags/movie") ? "bg-night text-white hover:bg-[#363e4f] focus:bg-[#363e4f]" : "text-[#6F7275] hover:bg-[#F0EDFF] focus:bg-[#F0EDFF]"}`}>
                    ...
                    <Link href={route('tags.show', 'literature')} className={`flex items-center gap-3 w-full px-4 py-2 text-start text-[14px] font-medium rounded-md leading-5 transition duration-150 ease-in-out focus:outline-none cursor-pointer ${isActiveURL("tags/literature") ? "bg-night text-white hover:bg-[#363e4f] focus:bg-[#363e4f]" : "text-[#6F7275] hover:bg-[#F0EDFF] focus:bg-[#F0EDFF]"}`}>
                    ...
                    <Link href={route('tags.show', 'technologies')} className={`flex items-center gap-3 w-full px-4 py-2 text-start text-[14px] font-medium rounded-md leading-5 transition duration-150 ease-in-out focus:outline-none cursor-pointer ${isActiveURL("tags/technologies") ? "bg-night text-white hover:bg-[#363e4f] focus:bg-[#363e4f]" : "text-[#6F7275] hover:bg-[#F0EDFF] focus:bg-[#F0EDFF]"}`}>
                    ...
                    <Link href={route('tags.show', 'cosplay')} className={`flex items-center gap-3 w-full px-4 py-2 text-start text-[14px] font-medium rounded-md leading-5 transition duration-150 ease-in-out focus:outline-none cursor-pointer ${isActiveURL("tags/cosplay") ? "bg-night text-white hover:bg-[#363e4f] focus:bg-[#363e4f]" : "text-[#6F7275] hover:bg-[#F0EDFF] focus:bg-[#F0EDFF]"}`}>
                    ...
                    <Link href={route('tags.show', 'business')} className={`flex items-center gap-3 w-full px-4 py-2 text-start text-[14px] font-medium rounded-md leading-5 transition duration-150 ease-in-out focus:outline-none cursor-pointer ${isActiveURL("tags/business") ? "bg-night text-white hover:bg-[#363e4f] focus:bg-[#363e4f]" : "text-[#6F7275] hover:bg-[#F0EDFF] focus:bg-[#F0EDFF]"}`}>
